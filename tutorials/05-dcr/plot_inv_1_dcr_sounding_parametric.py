...
reg_rho = regularization.LeastSquaresRegularization(mesh_rho, alpha_s=0.01, alpha_x=1, mapping=wire_map.rho)

# Define the regularization on the parameters related to layer thickness
mesh_t = TensorMesh([mesh.hx.size - 1])
reg_t = regularization.LeastSquaresRegularization(mesh_t, alpha_s=0.01, alpha_x=1, mapping=wire_map.t)
