"""
DC: Petrophysically Guided Inversion (PGI)
==========================================
...
proportions_mesh = np.ones((meshCore.nC,3))*np.r_[1.,tol_log,tol_log]
...
proportions_mesh[between_2m_8m] = np.ones(3)/3. # equal probabilities
...
title_list = ['a) True model', 'b) PGI with full petrophysical info.', 'c) PGI with no mean info.', 'd) PGI with depth but no mean info']
