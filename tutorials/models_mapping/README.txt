...
property values for each cell in the mesh. This method and additional methods for parameterizing models will be demonstrated in the tutorials.
...
mesh. For different types of models, we will demonstrate how this mapping is generated and applied.