...
This file will be deleted when the ``simpeg.directives.pgi_directives`` submodule is
removed.
"""

import warnings
from ._pgi_directives import *  # noqa: F403,F401

warnings.warn(
    "The `simpeg.directives.pgi_directives` submodule has been deprecated, "
