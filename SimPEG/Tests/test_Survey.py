...
class DataAndFieldsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Src0 = Survey.BaseSrc(srcLoc, [rxList0])
        rxList1 = Survey.BaseRx(XYZ, 'bxi')
        Src1 = Survey.BaseSrc(srcLoc, [rxList1])
        rxList2 = Survey.BaseRx(XYZ, 'bxi')
        Src2 = Survey.BaseSrc(srcLoc, [rxList2])
        rxList3 = Survey.BaseRx(XYZ, 'bxi')
        Src3 = Survey.BaseSrc(srcLoc, [rxList3])
        Src4 = Survey.BaseSrc(srcLoc, [rxList0, rxList1, rxList2, rxList3])
