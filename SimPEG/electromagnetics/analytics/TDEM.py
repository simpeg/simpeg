...
def TransientMagneticDipoleWholeSpace(XYZ, srcLoc, sig, t, moment, fieldType='h', mu_r=1):
    """
...
def TransientElectricDipoleWholeSpace(XYZ, srcLoc, sig, t, moment, fieldType='h', mu_r=1):
    ...
    if fieldType == 'e':
        ...
        front = (1 / (4.*pi*r**3)) * (erf(kr) - 2*kr*np.exp(-kr**2)/np.sqrt(pi))
