...
def run_inversion(
    ...
    reg_eta = regularization.Simple(mesh, mapping=wires.eta, active_cells=actind)
    reg_tau = regularization.Simple(mesh, mapping=wires.tau, active_cells=actind)
    reg_c = regularization.Simple(mesh, mapping=wires.c, active_cells=actind)
