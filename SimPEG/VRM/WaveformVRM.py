...
KWARGS:
	...
	def getCharDecay(self, fieldType, times):
		...
		"""
		Characteristic decay function for step-off waveform. This function describes the decay of the VRM
response for the Linear problem type. Note that the current will be normalized by its maximum value. The maximum current
in the transmitter is specified in the source object.
...
KWARGS:
	...
	def getCharDecay(self, fieldType, times):
		...
		"""
		Characteristic decay function for square-pulse waveform. This function describes the decay of the VRM
response for the Linear problem type. Note that the current will be normalized by its maximum value. The maximum current
in the transmitter is specified in the source object.
...
class Arbitrary():
	...
	"""
	Arbitrary waveform for predicting VRM response. Note that the current will be normalized by its maximum value. The maximum current
in the transmitter is specified in the source object.
...
INPUTS:
	...
	def getCharDecay(self, fieldType, times):
		...
		"""
		Characteristic decay function for arbitrary waveform. This function describes the decay of the VRM
response for the Linear problem type. Note that the current will be normalized by its maximum value. The maximum current
in the transmitter is specified in the source object.
...
INPUTS:
	...
	times: Observation times. These times must be during the off-time.
		...
		g = np.interp(tvec+dt/2,twave,Iwave) # g evaluated at middle of pulses
