...
im = utils.model_utils.plot2Ddata(xyzLoc, synthetic_data, ax=ax)
plt.colorbar(im[0])
...
utils.model_utils.plot2Ddata(xyzLoc, invProb.dpred, ax=ax)
ax.set_title('Predicted data.')
plt.gca().set_aspect('equal', adjustable='box')

ax = plt.subplot(1, 2, 2)
utils.model_utils.plot2Ddata(xyzLoc, synthetic_data-invProb.dpred, ax=ax)
