...
from SimPEG.electromagnetics.analytics.TDEM import (
    TransientElectricDipoleWholeSpace, TransientMagneticDipoleWholeSpace)
...
for ii in range(0, 3):
    ...
    Hx, Hy, Hz = TransientMagneticDipoleWholeSpace(
        observation_locations, source_location, sig, t[ii],
        moment='Z', fieldType='h', mu_r=1
    )
...
for ii in range(0, 3):
    ...
    dHdtx, dHdty, dHdtz = TransientMagneticDipoleWholeSpace(
        observation_locations, source_location, sig, t[ii],
        moment='Z', fieldType='dhdt', mu_r=1
    )
