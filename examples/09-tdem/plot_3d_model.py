...
# Plot cube
plt.plot([450, 1550, 1550, 450, 450], [-2300, -2300, -2700, -2700, -2300],
         'k-')
plt.plot([300, 1400, 1400, 300, 300], [-2350, -2350, -2750, -2750, -2350],
         'k:')
plt.plot([600, 600, 1700, 1700, 1550], [-2300, -2250, -2250, -2650, -2650],
         'k:')
...
plt.text(1000, -1925, r'$\rho_\mathrm{sea}=0.3\,\Omega\,$m',
         horizontalalignment='center')
plt.text(1000, -2150, r'$\rho_\mathrm{bg}=1.0\,\Omega\,$m',
         horizontalalignment='center')
plt.text(1000, -2550, r'$\rho_\mathrm{tg}=100.0\,\Omega\,$m',
         horizontalalignment='center')
plt.text(1500, -2800, r'$y=-500\,$m', horizontalalignment='left')
plt.text(1750, -2650, r'$y=500\,$m', horizontalalignment='left')

# Ticks and labels
plt.xticks([-50, 50, 450, 1550, 2000],
           ['$-50~$ $~$  $~$', ' $~50$', '$450$', '$1550$', '$2000$'])
plt.yticks([-1950, -2000, -2300, -2700],
           ['$-1950$\n', '\n$-2000$', '$-2300$', '$-2700$'])
...
print(f"Rec-{{x;y;z}} :: {rec[0] in np.round(mesh.vectorCCx)!s:>5}; "
      f"{rec[1] in np.round(mesh.vectorNy)!s:>5}; "
      f"{rec[2] in np.round(mesh.vectorNz)!s:>5}")
print(f"Src-x       :: {src[0] in np.round(mesh.vectorCCx)!s:>5}; "
      f"{src[1] in np.round(mesh.vectorCCx)!s:>5}")
print(f"Src-y       :: {src[2] in np.round(mesh.vectorNy)!s:>5}; "
      f"{src[3] in np.round(mesh.vectorNy)!s:>5}")
print(f"Src-z       :: {src[4] in np.round(mesh.vectorNz)!s:>5}; "
