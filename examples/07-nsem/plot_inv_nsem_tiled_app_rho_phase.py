...
def run():
    ...
    for rx_orientation in ['xy', 'yx']:
        rxList.append(ns.receivers.PointNaturalSource(locations=None, locations_e=receiver_locations, locations_h=receiver_locations, orientation=rx_orientation, component='apparent_resistivity'))
        rxList.append(ns.receivers.PointNaturalSource(locations=None,locations_e=receiver_locations, locations_h=receiver_locations, orientation=rx_orientation, component='phase'))
