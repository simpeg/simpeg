...
class FaceInnerProductFuntionsIsotropic(object):
...
class FaceInnerProductFunctionsDiagAnisotropic(FaceInnerProductFuntionsIsotropic):
    """ Some made up face functions to test the diagonally anisotropic face inner product """
...
class EdgeInnerProductFuntionsIsotropic(object):
...
class EdgeInnerProductFunctionsDiagAnisotropic(EdgeInnerProductFuntionsIsotropic):
    """ Some made up edge functions to test the diagonally anisotropic edge inner product """
...
class TestCylInnerProducts_simple(unittest.TestCase):
    ...
    def test_FaceInnerProductIsotropic(self):
        ...
        fcts = FaceInnerProductFuntionsIsotropic()
    ...
    def test_FaceInnerProductDiagAnisotropic(self):
        ...
        sig, jv = fcts.vectors(self.mesh)
        # print np.c_[sig].shape
        # sig = Utils.makePropertyTensor(self.mesh, np.c_[].T)
    ...
    def test_EdgeInnerProduct(self):
        ...
        fcts = EdgeInnerProductFuntionsIsotropic()
...
class TestCylFaceInnerProducts_Order(Tests.OrderTest):
    ...
    def getError(self):
        fct = FaceInnerProductFuntionsIsotropic()
...
class TestCylEdgeInnerProducts_Order(Tests.OrderTest):
    ...
    def getError(self):
        fct = EdgeInnerProductFuntionsIsotropic()
...
class TestCylInnerProducts_Deriv(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.x0 = 2*self.mesh.gridCC[:,0]**2 + self.mesh.gridCC[:,2]**4 # make up a smooth function
    ...
    def test_FaceInnerProductIsotropicDeriv(self):
        ...
        return self.assertTrue(Tests.checkDerivative(fun, self.x0, num=7, tolerance=TOLD, plotIt=False))
    ...
    def test_FaceInnerProductIsotropicDerivInvPropInvMat(self):
        ...
        def fun(x):
            ...
            MfSigDeriv = self.mesh.getFaceInnerProductDeriv(self.x0, invProp=True, invMat=True)
            return MfSig*self.face_vec, MfSigDeriv(self.face_vec)
    ...
    def test_EdgeInnerProductIsotropicDerivInvPropInvMat(self):
        ...
        def fun(x):
            ...
            MeSigDeriv = self.mesh.getEdgeInnerProductDeriv(self.x0, invProp=True, invMat=True)
            return MeSig*self.edge_vec, MeSigDeriv(self.edge_vec)
