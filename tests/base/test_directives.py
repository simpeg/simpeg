...
class ValidationInInversion(unittest.TestCase):
    ...
    def test_sensitivity_weighting_global(self):
        ...
        for reg_i in reg.objfcts:
            # Get weights as the products of every weights in the regularization
            weights = np.prod(list(reg_i._weights.values()), axis=0)
...
class TestNormalizationMethodSetter:
    ...
    def test_normalization_method_setter_valid(self, normalization_method):
        ...
        The normalization_method must be a string or a None. This test was included
        as part of the deprecation process of the old 'normalization' property.
        """
