...
class FieldsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.F = fields.Fields(sim, knownFields={'phi': 'CC',
                                                           'e': 'E', 'b': 'F'},
    ...
    def test_overlappingFields(self):
        self.assertRaises(
            AssertionError, fields.Fields, self.simulation, knownFields={'b': 'F'},
...
class FieldsTest_Alias(unittest.TestCase):
    ...
    def test_aliasFunction(self):
        ...
        F = fields.Fields(
            self.simulation, knownFields={'e': 'E'},
...
class FieldsTest_Time_Aliased(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.F = fields.TimeFields(sim, knownFields={'b': 'F'},
    ...
    def test_aliasFunction(self):
        ...
        def alias(e, srcInd, timeInd):
            ...
            return self.F.mesh.edgeCurl * e
        F = fields.TimeFields(self.simulation,
                               knownFields={'e': 'E'},
                               aliasFields={'b': ['e', 'F', alias]})
