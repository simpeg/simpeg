...
class PrimSecFDEMSrcTest_Cyl2Cart_EB_EB(unittest.TestCase):

    @classmethod
    def setUpClass(self):

        print('\n----------- Testing Primary Secondary Source -------------\n')
        # receivers
        self.rxlist = []
        for rxtype in ['b', 'e']:
        ...
        # primary
        self.primaryProblem = FDEM.Problem3D_b(meshp, mapping=primaryMapping)
