...
class DCProblemTestsN_Neumann(DCProblem_2DTests):
...
class DCProblemTestsN_Neumann_storeJ(DCProblem_2DTests):
    formulation = "Simulation2DNodal"
    storeJ = True
    adjoint_tol = 1e-8
    bc_type = "Neumann"
...
class DCProblemTestsCC_Neumann_AxialAnisotropy_storeJ(
    DCProblem_2DTests_Axial_Anisotropy
):
    formulation = "Simulation2DNodal"
    bc_type = "Neumann"
    storeJ = True
...
class DCProblemTestsCC_Dirichlet_AxialAnisotropy_storeJ(
    DCProblem_2DTests_Axial_Anisotropy
):
    formulation = "Simulation2DCellCentered"
    storeJ = True
