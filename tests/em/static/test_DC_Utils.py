...
class DCUtilsTests_halfspace(unittest.TestCase):
    ...
    def test_io_rhoa(self):
        ...
        for survey_type, test_file, rhoa_file in zip(
            ...
            ['2sph_dipole_dipole.obs', '2sph_pole_dipole.obs', '2sph_dipole_pole.obs', '2sph_pole_pole.obs'],
            ['rhoA_GIF_dd.txt', 'rhoA_GIF_pd.txt', 'rhoA_GIF_dp.txt', 'rhoA_GIF_pp.txt']
        ):
            ...
            utils.writeUBC_DCobs(
                surveyfile, dobs, survey_type=survey_type, dim=3,
                format_type='GENERAL'
            )
            ...
            rhoapp = utils.apparent_resistivity(
                dobs, survey_type=survey_type, space_type='half-space', eps=0.
            )
