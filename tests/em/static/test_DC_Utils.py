...
class DCUtilsTests_halfspace(unittest.TestCase):
    ...
    def test_dipole_dipole(self):
        ...
        utils.writeUBC_DCobs(
            surveyfile, dobs, dim=3, format_type='GENERAL'
        )
        ...
        rhoapp = utils.apparent_resistivity(
            dobs, survey_type='dipole-dipole', space_type='half-space', eps=0.
        )
...
#         # Create synthetic data
#         problem.make_synthetic_data(self.model, std=0.)
#         survey.eps = 1e-5
...
#         )
#         survey = utils.readUBC_DC3Dobs(surveyfile)
...
#         DCsurvey = utils.readUBC_DC3Dobs(survey_file)
