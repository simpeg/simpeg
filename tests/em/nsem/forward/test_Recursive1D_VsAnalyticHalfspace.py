...
class TestRecursiveForward(unittest.TestCase):
    ...
    def test_2(self):
        np.testing.assert_allclose(*compute_simulation(0.1, 1.))

    def test_3(self):
        np.testing.assert_allclose(*compute_simulation(100., 0.001))

    def test_4(self):
        np.testing.assert_allclose(*compute_simulation(100., 1.))
