...
nitpick_ignore = [
    ...
    ('py:class', 'SimPEG.electromagnetics.natural_source.utils.plotUtils.DataNSEMPlotMethods'),
    ...
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.simulation.Problem_BaseVRM'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.simulation.Problem_Linear'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.simulation.Problem_LogUniform'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.receivers.BaseRxVRM'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.receivers.Point_h'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.receivers.Point_dhdt'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.receivers.Point_b'),
    ('py:class', 'SimPEG.electromagnetics.viscous_remanent_magnetization.receivers.Point_dbdt'),
