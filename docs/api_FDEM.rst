...
Background
==========
Electromagnetic geophysical methods are used
...
where \\ \omega\\ is angular frequency, \\t\\ is time, \\ F(\omega) \\ is the function defined in the frequency domain and \\ f(t) \\ is the function defined in the time domain.
