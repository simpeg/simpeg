...
These changes within this section are also the ones while will require the largest
...
* ``Problem.makeSyntheticData`` → ``Simulation.make_synhetic_data``
...
There were 18 pull requests contributing a combination of 28,270, code line
additions and 15,494 removals.
...
Combining to produce 535 individual commits:
